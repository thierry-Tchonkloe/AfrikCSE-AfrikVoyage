...
router.patch("/categories/:id",  authorize("SUPER_ADMIN", "ADMIN"), ctrl.updateCategory.bind(ctrl));
router.delete("/categories/:id", authorize("SUPER_ADMIN", "ADMIN"), ctrl.deleteCategory.bind(ctrl));
...
router.patch("/requests/:id/approve", authorize("SUPER_ADMIN", "ADMIN", "MANAGER"), ctrl.approveRequest.bind(ctrl));
router.patch("/requests/:id/reject",  authorize("SUPER_ADMIN", "ADMIN", "MANAGER"), ctrl.rejectRequest.bind(ctrl));
