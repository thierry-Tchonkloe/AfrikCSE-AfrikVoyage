...
router.post(  "/admin/properties",     authorize("SUPER_ADMIN", "PLATFORM_MANAGER"), idempotency(), ctrl.adminCreateProperty);
...
router.post(  "/admin/room-types",     authorize("SUPER_ADMIN", "PLATFORM_MANAGER"), idempotency(), ctrl.adminCreateRoomType);
