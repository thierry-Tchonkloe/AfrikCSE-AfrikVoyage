        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
                ...
                {SOCIAL_LINKS.map((s) => (
                    ...
                    aria-label={s.label}
                    className="w-8 h-8 rounded-full bg-blue-600 hover:bg-blue-500 flex items-center justify-center text-white transition-colors duration-200"
                    >
                    {s.icon}
                    </a>
                ))}
            ...
            {/* Bottom bar */}
            <div className="mt-12 pt-6 border-t border-gray-700/50 flex flex-col sm:flex-row items-center justify-between gap-4">
