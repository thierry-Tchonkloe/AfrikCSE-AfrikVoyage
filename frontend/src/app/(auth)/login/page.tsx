...
export default function LoginPage() {
    ...
    const onSubmit = async (data: FormData): Promise<void> => {
        ...
        try {
            ...
            // ✅ Le backend a posé accessToken + refreshToken en cookies HTTP-only
            //    via Set-Cookie dans la réponse /auth/login.
            ...
            // Profil incomplet → complétion obligatoire
            if (!profileCompleted) {
            window.location.href = "/complete-profile";
            return;
            }

            // Calcule la route de destination
            let destination: string;
            ...
            // Redirection — le middleware Edge Runtime lit le cookie HTTP-only
