...
export default function CompanyDashboardPage() {
    ...
    const MODULE_CARDS = [
        ...
        id: "cse",
        label: t("afrikcse"),
        desc: t("employeeBenefitsTicketing"),
        icon: Gift,
        active: org.hasCSE,
        color: "#0f766e",
    ...
    return (
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            <p className="text-sm text-gray-500">
                {t("plan", { name: org.name })} <strong>{org.plan}</strong>
            </p>
            </div>
            <span
        ...
        <div>
            ...
            {MODULE_CARDS.map((mod) => (
                ...
                <div className="flex items-center gap-3">
                    ...
                    >
                    {mod.active ? t("active2") : t("inactive")}
                    </span>
                </div>
                {mod.active ? (
                    <button
